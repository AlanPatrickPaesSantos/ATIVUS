...
import { createAdminUser, getAdminUsers, updateAdminUser, updateAdminUserSituation, type AdminUserMutableSituation } from '../api/administrationApi'
...
function UserDetail({ user, tab, onTabChange, onClose, onEdit, onSituationChange }: { user: AdminUser; tab: UserDetailTab; onTabChange: (tab: UserDetailTab) => void; onClose: () => void; onEdit: (user: AdminUser) => void; onSituationChange: (user: AdminUser, situation: AdminUserMutableSituation) => Promise<void> }) {
