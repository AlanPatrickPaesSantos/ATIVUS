...
- [x] **Step 1: Confirmar identidade local**
...
- [x] **Step 2: Confirmar autenticação GitHub**
...
- [x] **Step 3: Confirmar conta e destino**
...
- [x] **Step 3: Review sensitive file names and size**
...
- [x] **Step 1: Create the private repository**
...
- [x] **Step 4: Do not configure deployment yet**
